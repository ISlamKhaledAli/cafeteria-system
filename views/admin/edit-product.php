...
<div class="container-fluid py-4 px-4" style="background-color: #fcfcfc; min-height: 100vh;">
    ...
    <div class="d-flex align-items-center mb-4 gap-3">
        ...
        <h2 class="h4 fw-bold mb-0 text-dark">Edit Product</h2>
    </div>

    <div class="card border border-light shadow-sm" style="border-radius: 12px; max-width: 640px;">
        <div class="card-body p-4">

            <form action="index.php?page=admin-edit-product" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-muted text-uppercase" style="letter-spacing: 0.6px;">Current Image</label>
                    <div>
                ...
                <div class="mb-4">
                    <label for="image" class="form-label fw-semibold small text-muted text-uppercase" style="letter-spacing: 0.6px;">Change Image (optional)</label>
                    ...
                    <div id="imagePreview" class="mt-2" style="display:none;">
                        <img id="previewImg" src="#" alt="New Preview" class="rounded shadow-sm"
                             style="width: 80px; height: 80px; object-fit: cover;">
                    </div>
                </div>
