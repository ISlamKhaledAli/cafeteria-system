<?php
/**
 * Register View - Premium Cafeteria Auth
 */
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="auth-wrapper">
    <!-- Left Side: Branding (Same for consistency) -->
        ...
        <div class="auth-box">
            ...
            <form action="index.php?page=register" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-md-5">
                        <div class="form-floating">
                            <input type="text" name="ext" class="form-control" id="floatingExt" placeholder="1234">
                            <label for="floatingExt">Extension</label>
                        </div>
                    </div>
                </div>
